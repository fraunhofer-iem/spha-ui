    ...
    mockTools = [
      {
        ...
        icon: "https://example.com/eslint-icon.png",
      },
      {
        name: "SonarQube",
        scanDate: "2024-01-14T15:45:00Z",
        findings: [{ issue: "code-smell", severity: "major" }],
        downloadLink: "https://example.com/sonar",
      },
      {
        name: "Security Scanner",
        scanDate: "invalid-date",
        findings: [],
        downloadLink: "https://example.com/security",
      },
      {
        name: "Performance Tool",
        findings: [{ metric: "load-time", value: 2.5 }],
        downloadLink: "https://example.com/performance",
      },
    ];
      ...
      const mixedTools: Tool[] = [
        {
          ...
          findings: [{ type: "error" }],
          downloadLink: "https://example.com/a",
        ...
        },
        {
          ...
          scanDate: undefined,
          findings: [],
          downloadLink: "https://example.com/b",
        },
        {
          name: "Tool C",
          scanDate: "invalid",
          findings: undefined,
          downloadLink: "https://example.com/c",
        },
      ];
